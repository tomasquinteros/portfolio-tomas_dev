...
export const Footer = (images, data) => {
  ...
  <div class="flex flex-col items-center justify-center gap-4 md:flex-row md:gap-10">
      <a class="flex flex-row items-center justify-center gap-[10px]" href="../index.html">
        <img src="${imagesFooter.homeIcon}" alt="home-icon">
        Home
      </a>
      <a class="flex flex-row items-center justify-center gap-[10px]" href="../pages/services.html">
        <img src="${imagesFooter.servicesIcon}" alt="service-icon">
        Services
      </a>
      <a class="flex flex-row items-center justify-center gap-[10px]" href="../pages/contact.html">
